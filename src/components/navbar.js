  ...
  return (
    <Navbar collapseOnSelect expand="lg" className="navbar-expand-lg navbar-dark bg-primary">
      ...
      <Navbar.Collapse id="responsive-navbar-nav">
        ...
        <Nav>
          <Nav.Link href="https://www.linkedin.com/in/orlando-carnate/" className="d-flex align-items-center">
            <i className="fab fa-linkedin"></i>&nbsp;LinkedIn
          </Nav.Link>
          <Nav.Link href="https://github.com/orlandocarnate" className="d-flex align-items-center">
